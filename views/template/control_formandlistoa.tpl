...
func (ctl *${uppercomponentname$}Controller) Save${componentname$}() {
	...
	fiid, err = models.AddMulti${uppercomponentname$}(ob.Opinion, ob.Userid, ob.Currentfiid, ob.Currenttiid, ob.Actionid, ob.Modualid, ob.${firstuppercomponentname$}, ob.${firstuppercomponentname$}item)
